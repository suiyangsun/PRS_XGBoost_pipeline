...
A single script handles both ref-first and ref-last format via the optional `$6` argument:
...
| `$5` | Output prefix |
| `$6` | BGEN ref allele convention: `ref-last` (**default**) or `ref-first` (such as UKB genotype data) |
