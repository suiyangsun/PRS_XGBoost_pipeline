...
This pipeline takes genotype data and GWAS-derived effect sizes as input, computes per-individual Polygenic Risk Scores (PRS), evaluates their performance, and combines multiple PRS into an optimized prediction model using XGBoost.
...
**Input**: Genotype data (BGEN/PLINK) + Weight file (effect sizes)
